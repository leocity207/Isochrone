...
Algorithm_Station::Algorithm_Station(const Network:: Station* station_to_link, const Network_Optimizer* optimizer) noexcept : m_best_time(), m_basic_time(),m_reach_by_transport(false), m_ref_station(station_to_link), m_optimizer(optimizer)
{
...
const Network::Station& Algorithm_Station::Get() const noexcept
{
