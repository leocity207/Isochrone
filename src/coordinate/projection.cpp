...
{
	double x = Coordinate::Spherical::earth_radius * (coordinate.Longitude() - m_mean_coordinate.Longitude()) * std::numbers::pi / 180.0 * std::cos(coordinate.Latitude() * std::numbers::pi / 180.0);
