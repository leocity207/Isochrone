...
namespace Context
{
	...
	public:
		...
		/// @param station_to_link         The Network station to link to the context station
		/// @param reach_algorithm_context The reach algorithm context where this station should exist
